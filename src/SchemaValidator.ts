...
export class SchemaValidator {
   ...
   */
  public validate(instance: {}, schema: Schema): ValidatorResult {
   ...
   */
  public isValid(instance: {}, schema: Schema): boolean {
    return this.validate(instance, schema).errors.length === 0;
  }
}
